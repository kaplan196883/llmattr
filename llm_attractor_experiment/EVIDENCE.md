...
| §4.10 Volumetric bulk (marching-cubes iso-density at fractions 0.04, 0.10, 0.20, 0.35, 0.55) + 50-trajectory walk + red kick beams | `reports/perturbation/animation3d_<condition>_n50_seed0.mp4` (and `_n6` previews) | `src/experiments/perturbation/trajectory_animation_3d.py` (shell fractions at line ~50) |
