...
\begin{itemize}
  ...
  \item \textbf{The high-dose destination-coherent dip is real in the tested
  loop, not an artifact of how we built the perturbation.} At
  doses 1500 / 2000 / 3000, destination-coherent persistence was
  \textbf{0.51 / 0.32 / 0.41} with heterogeneous concatenated
  perturbations and \textbf{0.44 / 0.32 / 0.40} with homogeneous
  ...
  under homogeneous repetition (\textbf{0.54-0.58}) than under
  heterogeneous concatenation (\textbf{0.74-0.79}), suggesting that
